          ...
          <div className=" flex flex-wrap">
            <div className="w-full flex justify-between items-center px-4">
              <div className=" max-w-[800px] text-left w-[70%] ">
                ...
                <p className="max-w-[600px] pb-[20px]  " >Welcome to GENROAR_GROUPS, where innovation and excellence unite. Explore our diverse services in clothing, IT, and education, designed to empower your journey. Together, let's craft a brighter future!</p>
              ...
              <div className="banenr-rght w-[40%] ">
                <img className="w-[100%]" src="/images/2.png" alt="" />
              </div>
            </div>
          </div>
        </div>
